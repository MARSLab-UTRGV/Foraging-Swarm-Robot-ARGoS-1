    ...
    with open(sourceFile) as f1:
        if "<!-- <visualization>" in f1.read():
            if visualValue  == '1':
                ...
                print("The visualization is updated to ON ...")            elif visualValue  == '0':
                print("The default visualization has already been OFF *******")            return
...
def run(folder, dataFile):
    ...
    for file in targetFiles:
        ...
        if os.path.isfile(fileLocation):
            print("File: ", fileLocation)            if parameterDict.has_key("Visualization"):
